...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public List<String> getAllBookTitlesAfter() {
    ...
    @Override
    public int getBooksCountByAuthor(int id) {
        return this.bookRepository.findAllByAuthor_Id(id).size();
    }

    @Override
    public List<Book> getAllBooksByAuthor(int id) {
        return this.bookRepository.findAllByAuthor_IdOrderByReleaseDateDescTitleAsc(id);
    }
